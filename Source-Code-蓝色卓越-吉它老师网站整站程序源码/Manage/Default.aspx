       ...
       <%--                     <li><a href="javascript:;" onclick="showleft('menu2_4','Pub/PubExcel.aspx')"><%=Resources.L.Excel导出 %></a></li>--%>
            ...
            <ul class="menu6">
                ...
                <li class="menu6_8"><a onclick="showleft('menu6_8','APP/WSApi.aspx')"><%=Resources.L.整合接口 %></a></li>
                    <li class="menu6_8"><a onclick="showleft('menu6_9','User/Addon/UserGraph.aspx')">用户画像</a></li>
            </ul>
            <ul class="menu7">
            ...
            <ul class="menu9">
                ...
                <li class="menu9_5"><a onclick="showleft('menu9_5','iServer/BiServer.aspx?num=1')"><%=Resources.L.有问必答 %></a></li>
            ...
            <ul class="list-unstyled">
                ...
                <div id="menu6" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu6_9">
                        <li class="menu_tit"><span class="fa fa-chevron-down"></span>用户画像</li>
